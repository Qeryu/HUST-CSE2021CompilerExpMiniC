...
{
       0,   106,   106,   112,   113,   118,   122,   126,   131,   135,
     142,   147,   153,   157,   164,   169,   174,   182,   188,   190,
     196,   203,   207,   212,   219,   224,   225,   230,   234,   238,
     242,   246,   250,   254,   261,   262,   267,   273,   277,   282,
     286,   293,   299,   304,   309,   314,   320,   321,   322,   323,
     325,   330,   335,   340,   345,   349,   354,   360,   362,   363,
     368,   373,   379,   385,   386,   392,   397,   398,   399,   401,
     402
};
#endif
...
#line 106 "parser.y"
                    {
            p = new NProgram((yyvsp[0].nExtDefList));
            if ((yyvsp[0].nExtDefList)) 
                p->line = (yyvsp[0].nExtDefList)->line;
        }
...
#line 113 "parser.y"
                            {
            (yyval.nExtDefList) = new NExtDefList(*(yyvsp[-1].nExtDef),(yyvsp[0].nExtDefList));
            (yyval.nExtDefList)->line = (yyvsp[-1].nExtDef)->line;
        }
...
#line 118 "parser.y"
                                  {
            (yyval.nExtDef) = new NExtDef(*(yyvsp[-2].nSpecifier), (yyvsp[-1].nExtDecList));
            (yyval.nExtDef)->line = (yyvsp[-2].nSpecifier)->line;
        }
...
#line 122 "parser.y"
                         {
            (yyval.nExtDef) = new NExtDef(*(yyvsp[-1].nSpecifier));
            (yyval.nExtDef)->line = (yyvsp[-1].nSpecifier)->line;
        }
...
#line 126 "parser.y"
                                  {
            (yyval.nExtDef) = new NExtDef(*(yyvsp[-2].nSpecifier), (yyvsp[-1].nFunDec), (yyvsp[0].nCompSt));
            (yyval.nExtDef)->line = (yyvsp[-2].nSpecifier)->line;
        }
...
#line 131 "parser.y"
                   {
            (yyval.nExtDecList) = new NExtDecList(*(yyvsp[0].nVarDec), nullptr);
            (yyval.nExtDecList)->line = (yyvsp[0].nVarDec)->line;
        }
...
#line 135 "parser.y"
                                  {
            (yyval.nExtDecList) = new NExtDecList(*(yyvsp[-2].nVarDec), (yyvsp[0].nExtDecList));
            (yyval.nExtDecList)->line = (yyvsp[-2].nVarDec)->line;
        }
...
#line 142 "parser.y"
                {
            std::string *tmp = new std::string((yyvsp[0].type_id));
            (yyval.nSpecifier) = new NSpecifier(*tmp);
            (yyval.nSpecifier)->line = yylineno;
        }
...
#line 147 "parser.y"
                          {
            (yyval.nSpecifier) = new NSpecifier((yyvsp[0].nStructSpecifier)->parse()); 
            (yyval.nSpecifier)->line = (yyvsp[0].nStructSpecifier)->line;
        }
...
#line 153 "parser.y"
                                             {
            (yyval.nStructSpecifier) = new NStructSpecifier((yyvsp[-3].nIdentifier), (yyvsp[-1].nDefList));
            (yyval.nStructSpecifier)->line = (yyvsp[-3].nIdentifier)->line;
        }
...
#line 157 "parser.y"
                     {
            (yyval.nStructSpecifier) = new NStructSpecifier((yyvsp[0].nIdentifier));
...
#line 164 "parser.y"
           { 
            std::string *strID = new std::string((yyvsp[0].type_id)); 
            (yyval.nIdentifier) = new NIdentifier(*strID); 
            (yyval.nIdentifier)->line = yylineno-1; 
        }
...
#line 174 "parser.y"
        { 
            std::string *strID = new std::string((yyvsp[0].type_id));
            (yyval.nIdentifier) = new NIdentifier(*strID);
            (yyval.nIdentifier)->line = yylineno;
        }
...
#line 182 "parser.y"
            { 
            std::string *strID = new std::string((yyvsp[0].type_id)); 
            NIdentifier *nIdentifier = new NIdentifier(*strID);
            (yyval.nVarDec) = new NVarDec(*nIdentifier); 
            (yyval.nVarDec)->line = yylineno;
        }
#line 1781 "parser.cpp"
  ...
  case 18:
#line 188 "parser.y"
                           { (yyval.nVarDec) = (yyvsp[-3].nVarDec); (yyval.nVarDec)->line = (yyvsp[-3].nVarDec)->line; }
...
#line 190 "parser.y"
                         {
            std::string *strID = new std::string((yyvsp[-3].type_id)); 
            NIdentifier *nIdentifier = new NIdentifier(*strID);
            (yyval.nFunDec) = new NFunDec(*nIdentifier, (yyvsp[-1].nVarList));
            (yyval.nFunDec)->line = (yyvsp[-1].nVarList)->line;
        }
...
#line 196 "parser.y"
                   {
            std::string *strID = new std::string((yyvsp[-2].type_id)); 
            NIdentifier *nIdentifier = new NIdentifier(*strID);
            (yyval.nFunDec) = new NFunDec(*nIdentifier, nullptr);
            (yyval.nFunDec)->line = yylineno;
        }
...
#line 203 "parser.y"
                  {
            (yyval.nVarList) = new NVarList(*(yyvsp[0].nParamDec), nullptr);
            (yyval.nVarList)->line = (yyvsp[0].nParamDec)->line;
        }
...
#line 207 "parser.y"
                                 {
            (yyval.nVarList) = new NVarList(*(yyvsp[-2].nParamDec), (yyvsp[0].nVarList));
            (yyval.nVarList)->line = (yyvsp[-2].nParamDec)->line;
        }
...
#line 212 "parser.y"
                           {
            (yyval.nParamDec) = new NParamDec(*(yyvsp[-1].nSpecifier), *(yyvsp[0].nVarDec));
            (yyval.nParamDec)->line = (yyvsp[-1].nSpecifier)->line;
        }
...
#line 219 "parser.y"
                                 {
            (yyval.nCompSt) = new NCompSt((yyvsp[-2].nDefList), (yyvsp[-1].nStmtList));
            (yyval.nCompSt)->line = (yyvsp[-3].line);
        }
...
#line 225 "parser.y"
                         {
            (yyval.nStmtList) = new NStmtList(*(yyvsp[-1].nStmt), (yyvsp[0].nStmtList));
            (yyval.nStmtList)->line = (yyvsp[-1].nStmt)->line;
        }
...
#line 230 "parser.y"
                   {
            (yyval.nStmt) = new NExpStmt(*(yyvsp[-1].nExpression));
            (yyval.nStmt)->line = (yyvsp[-1].nExpression)->line;
        }
...
#line 234 "parser.y"
                 {
            (yyval.nStmt) = new NCompStStmt(*(yyvsp[0].nCompSt));
            (yyval.nStmt)->line = (yyvsp[0].nCompSt)->line;
        }
...
#line 238 "parser.y"
                          {
            (yyval.nStmt) = new NRetutnStmt(*(yyvsp[-1].nExpression));
            (yyval.nStmt)->line = (yyvsp[-1].nExpression)->line;
        }
...
#line 242 "parser.y"
                                                  {
            (yyval.nStmt) = new NIfStmt(*(yyvsp[-2].nExpression), *(yyvsp[0].nStmt));
            (yyval.nStmt)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 246 "parser.y"
                                      {
            (yyval.nStmt) = new NIfElseStmt(*(yyvsp[-4].nExpression), *(yyvsp[-2].nStmt), *(yyvsp[0].nStmt));
            (yyval.nStmt)->line = (yyvsp[-4].nExpression)->line;
        }
...
#line 250 "parser.y"
                               {
            (yyval.nStmt) = new NWhileStmt(*(yyvsp[-2].nExpression), *(yyvsp[0].nStmt));
            (yyval.nStmt)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 254 "parser.y"
                     {
            (yyval.nStmt) = new NBreakStmt();
            (yyval.nStmt)->line = (yyvsp[-1].line);
        }
...
#line 262 "parser.y"
                      {
            (yyval.nDefList) = new NDefList(*(yyvsp[-1].nDef), (yyvsp[0].nDefList));
            (yyval.nDefList)->line = (yyvsp[-1].nDef)->line;
        }
...
#line 267 "parser.y"
                            {
            (yyval.nDef) = new NDef(*(yyvsp[-2].nSpecifier), (yyvsp[-1].nDecList));
            (yyval.nDef)->line = (yyvsp[-2].nSpecifier)->line;
        }
...
#line 273 "parser.y"
             {
            (yyval.nDecList) = new NDecList(*(yyvsp[0].nDec), nullptr);
            (yyval.nDecList)->line = (yyvsp[0].nDec)->line;
        }
...
#line 277 "parser.y"
                             {
            (yyval.nDecList) = new NDecList(*(yyvsp[-2].nDec), (yyvsp[0].nDecList));
            (yyval.nDecList)->line = (yyvsp[-2].nDec)->line;
        }
...
#line 282 "parser.y"
               {
            (yyval.nDec) = new NDec(*(yyvsp[0].nVarDec));
            (yyval.nDec)->line = (yyvsp[0].nVarDec)->line;
        }
...
#line 286 "parser.y"
                               {
            (yyval.nDec) = new NDec(*(yyvsp[-2].nVarDec), (yyvsp[0].nExpression));
            (yyval.nDec)->line = (yyvsp[-2].nVarDec)->line;
        }
...
#line 293 "parser.y"
                           {
            std::string name = "ASSIGNOP";
            (yyval.nExpression) = new NAssignment(name, *(yyvsp[-2].nExpression), ASSIGNOP, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 299 "parser.y"
                            {
            std::string name = "PLUSASS";
            (yyval.nExpression) = new NAssignment(name, *(yyvsp[-2].nExpression), PLUSASS, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 304 "parser.y"
                             {
            std::string name = "MINUSASS";
            (yyval.nExpression) = new NAssignment(name, *(yyvsp[-2].nExpression), MINUSASS, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 309 "parser.y"
                            {
            std::string name = "STARASS";
            (yyval.nExpression) = new NAssignment(name, *(yyvsp[-2].nExpression), STARASS, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 314 "parser.y"
                           {
            std::string name = "DIVASS";
            (yyval.nExpression) = new NAssignment(name, *(yyvsp[-2].nExpression), DIVASS, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 325 "parser.y"
                        {
            std::string name = "AND";
            (yyval.nExpression) = new NBinaryOperator(name, *(yyvsp[-2].nExpression), AND, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 330 "parser.y"
                        {
            std::string name = "OR";
            (yyval.nExpression) = new NBinaryOperator(name, *(yyvsp[-2].nExpression), OR, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 335 "parser.y"
                        {
            std::string name = "RELOP";
            (yyval.nExpression) = new NBinaryOperator(name, *(yyvsp[-2].nExpression), RELOP, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 340 "parser.y"
            ...
            (yyval.nExpression) = new NBinaryOperator(name, *(yyvsp[-2].nExpression), PLUS, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 345 "parser.y"
            ...
            (yyval.nExpression) = new NBinaryOperator(name, *(yyvsp[-2].nExpression), MINUS, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;}
...
#line 349 "parser.y"
            ...
            (yyval.nExpression) = new NBinaryOperator(name, *(yyvsp[-2].nExpression), STAR, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 354 "parser.y"
                        {
            std::string name = "DIV";
            (yyval.nExpression) = new NBinaryOperator(name, *(yyvsp[-2].nExpression), DIV, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 363 "parser.y"
                                   {
            std::string name = "MINUS";
            (yyval.nExpression) = new NSingleOperator(name, MINUS, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[0].nExpression)->line;
        }
...
#line 368 "parser.y"
                        {
            std::string name = "NOT";
            (yyval.nExpression) = new NSingleOperator(name, NOT, *(yyvsp[0].nExpression));
            (yyval.nExpression)->line = (yyvsp[0].nExpression)->line;
        }
...
#line 373 "parser.y"
                        {
            auto strID = new std::string((yyvsp[-3].type_id));
            auto id = new NIdentifier(*strID);
            (yyval.nExpression) = new NMethodCall(*id, (yyvsp[-1].nArgs));
            (yyval.nExpression)->line = (yyvsp[-2].line);
        }
...
#line 379 "parser.y"
                        {
            auto strID = new std::string((yyvsp[-2].type_id));
            auto id = new NIdentifier(*strID);
            (yyval.nExpression) = new NMethodCall(*id, nullptr);
            (yyval.nExpression)->line = (yyvsp[-1].line);
        }
...
#line 386 "parser.y"
            ...
            std::string *strID = new std::string((yyvsp[0].type_id)); 
            NIdentifier *nIdentifier = new NIdentifier(*strID);
            (yyval.nExpression) = new NDotOperator(*(yyvsp[-2].nExpression), *nIdentifier);
            (yyval.nExpression)->line = (yyvsp[-2].nExpression)->line;
        }
...
#line 392 "parser.y"
                        {
            auto strID = new std::string((yyvsp[0].type_id));
            (yyval.nExpression) = new NIdentifier(*strID);
            (yyval.nExpression)->line = yylineno;
        }
